...
export default function Vegetables() {
  ...
  const fire = (uid) => {
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        await deleteDoc(doc(db, "Vegetable", uid));
        swalWithBootstrapButtons.fire(
          'Deleted!',
  ...
  return (
    ...
    {
      update === true ?
        <UpdateItem category="Vegetable" pID={productID} productImg={url} productName={itemName} productUnitName={unitName} productDesc={desc} productQuantity={quantity} productUnitPrice={unitPrice} /> :
        <div>
          <CategoryBar className={'categoryBar'} backBtn={'true'} loc={"Vegetables"} />
