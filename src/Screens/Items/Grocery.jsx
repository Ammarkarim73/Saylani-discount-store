...
export default function Grocery() {
  ...
  const fire = (uid) => {
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        await deleteDoc(doc(db, "Grocery Items", uid));
        swalWithBootstrapButtons.fire(
          'Deleted!',
  ...
  const updateItem = (uid, imgUrl, itemName, unitName, unitPrice, Quantity, desc) => {
    Swal.fire({
      ...
      html:
        ...
        `<p><b>Category:</b> Grocery Items </p>` +
  ...
  return (
    ...
    {
      update === true ?
        <UpdateItem category="Grocery Items" pID={productID} productImg={url} productName={itemName} productUnitName={unitName} productDesc={desc} productQuantity={quantity} productUnitPrice={unitPrice} /> :
        <div>
          <CategoryBar className={'categoryBar'} backBtn={'true'} loc={"Grocery Items"} />
